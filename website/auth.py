...
def callback():
    ...
    if not user:
        ...
        new_user = User(
            ...
            # برای password باید یک رشته تصادفی ایجاد شود زیرا Google password را ارائه نمی‌دهد
        )
    ...
    flash('Logged in successfully!', category='success')
    login_user(user, remember=True)
    return redirect(url_for('views.home'))  # تغییر از 'protected_area' به 'views.home'
